/* Ported verbatim from prototype_v2/icons.js -- same names, same hand-drawn
   paths (Lucide visual language, 24x24, 2px stroke, round caps/joins), so
   swapping to real lucide-react later is a rename, not a redesign. */
const ICON_PATHS = {
