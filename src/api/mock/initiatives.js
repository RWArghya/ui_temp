...
export const MOCK_USER_INITIATIVES = {
  ...
  /** Active (registered, not yet ended) — ongoing programs on Hack2skill */
  active: [
    {
      id: 'agentic-bootcamp',
    ...
    {
      id: 'icc-global',
      name: 'ICC Global Cricket Hackathon',
    ...
    {
      id: 'npci-upi',
      name: 'NPCI UPI Fraud Detection Challenge',
      org: 'NPCI',
      purpose: 'learncompete',
      status: 'live',
      deadline: '2026-11-05',
    ...
    {
      id: 'isro-bhuvan',
      name: 'ISRO Bhuvan Geospatial Challenge',
      org: 'ISRO',
      purpose: 'learncompete',
      status: 'live',
      deadline: '2026-11-25',
