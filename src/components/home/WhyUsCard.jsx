...
export default function WhyUsCard({ icon, title, description }) {
  return (
    <div className="group relative overflow-hidden rounded-card border border-paper-line bg-paper-raised p-6 transition-all duration-200 hover:border-graphite-dim/50 hover:shadow-[0_18px_40px_-26px_rgba(15,22,41,.3)]">
